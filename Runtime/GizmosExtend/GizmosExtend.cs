...
namespace Kit
{
    ...
    public static class GizmosExtend
    {
        ...
        public static void DrawSquare(Vector3 center, Vector3 direction, Vector2 size, float angle, Color color)
        {
            Gizmos.color = color;
            ...
            // Calculate the rotation based on the direction and angle
            Quaternion rotation = Quaternion.LookRotation(direction) * Quaternion.Euler(0, 0, angle);

            // Define half extents for the square
            Vector2 halfSize = size * 0.5f;

            // Calculate the vertices of the square in local space
            Vector3[] vertices = new Vector3[4];
            vertices[0] = new Vector3(-halfSize.x, -halfSize.y, 0); // Bottom-left
            vertices[1] = new Vector3(halfSize.x, -halfSize.y, 0);  // Bottom-right
            vertices[2] = new Vector3(halfSize.x, halfSize.y, 0);   // Top-right
            vertices[3] = new Vector3(-halfSize.x, halfSize.y, 0);  // Top-left
