...
namespace Sabresaurus.PlayerPrefsEditor
{
    public class PlayerPrefsEditor : EditorWindow
    {
        ...
        [MenuItem("Tools/Thinhnv/PlayerPrefs Editor")]
    ...
    // ─────────────────────────────────────────────────────────────────────────────
    // Inline codecs — copied verbatim from the retired Runtime assembly
    // (Sabresaurus.PlayerPrefsUtilities) so the Editor no longer references it.
    // ─────────────────────────────────────────────────────────────────────────────

    /// <summary>
    /// Encrypted PlayerPrefs helpers. Verbatim copy of the Runtime implementation,
    /// kept inside the Editor namespace to drop the Runtime assembly reference.
    /// </summary>
    internal static class PlayerPrefsUtility
    {
        ...
        /// <summary>Determines if the specified player pref key refers to an encrypted record</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.SetFloat(), stored key and value is encrypted in player prefs</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.SetInt(), stored key and value is encrypted in player prefs</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.SetString(), stored key and value is encrypted in player prefs</summary>
        ...
        /// <summary>Encrypted version of EditorPrefs.SetBool(), stored key and value is encrypted in player prefs</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.GetFloat(), an unencrypted key is passed and the value is returned decrypted</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.GetInt(), an unencrypted key is passed and the value is returned decrypted</summary>
        ...
        /// <summary>Encrypted version of PlayerPrefs.GetString(), an unencrypted key is passed and the value is returned decrypted</summary>
        ...
        /// <summary>Encrypted version of EditorPrefs.GetBool(), an unencrypted key is passed and the value is returned decrypted</summary>
        public static bool GetEncryptedBool(string key, bool defaultValue = false)
        {
            // Encrypt and prefix the key so we can look it up from player prefs
            string encryptedKey = KEY_PREFIX + SimpleEncryption.EncryptString(key);

            // Look up the encrypted value (note bools are stored via EditorPrefs since PlayerPrefs doesn't natively support bools)
            string fetchedString = EditorPrefs.GetString(encryptedKey);
            ...
            if (!string.IsNullOrEmpty(fetchedString))
            {
                ...
                // Decrypt and return the bool value
                return SimpleEncryption.DecryptBool(fetchedString);
            }
            else
            {
                // No existing pref value, so return defaultValue instead
                return defaultValue;
            }
        }
    }
    ...
    /// <summary>
    /// AES/Rijndael string/number/bool encryption helper. Verbatim copy of the Runtime
    /// implementation, kept inside the Editor namespace to drop the Runtime assembly reference.
    ...
    /// </summary>
    internal static class SimpleEncryption
    {
        ...
        /// <summary>Encrypts the specified float value and returns an encrypted string</summary>
        ...
        /// <summary>Encrypts the specified int value and returns an encrypted string</summary>
        ...
        /// <summary>Encrypts the specified bool value and returns an encrypted string</summary>
        ...
        /// <summary>Decrypts the encrypted string representing a float into the decrypted float</summary>
        ...
        /// <summary>Decrypts the encrypted string representing an int into the decrypted int</summary>
        ...
        /// <summary>Decrypts the encrypted string representing a bool into the decrypted bool</summary>
